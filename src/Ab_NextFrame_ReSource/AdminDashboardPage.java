...
import Ab_NextFrame_ReSource.A_Frame_Admin.AdminOverviewDisplay;
import Ab_NextFrame_ReSource.A_Frame_Admin.AdminListDisplay;
import Ab_NextFrame_ReSource.A_Frame_Admin.AdminStuffDisplay;
import Ab_NextFrame_ReSource.A_Frame_Admin.AdminOrderDisplay;
...
public class AdminDashboardPage extends javax.swing.JFrame {
    ...
    public AdminDashboardPage() {
        ...
        String identiNama = kirimNilai("Imnat");
        String identiNumb = kirimNilai("123498763690");
        //
    ...
    private void initComponents() {
        ...
        optingLiatin = new javax.swing.JButton();
        optingCustor = new javax.swing.JButton();
        optingStuffs = new javax.swing.JButton();
        optingPesanan = new javax.swing.JButton();
        ...
        kendaliServis.setToolTipText("Admin Dasbor Panel - Control");
        ...
        welKom.setText(" Welcome back,");
        welKom.setToolTipText("");
        welKom.setMaximumSize(new java.awt.Dimension(300, 40));
        welKom.setMinimumSize(new java.awt.Dimension(300, 40));
        welKom.setPreferredSize(new java.awt.Dimension(300, 40));
        ...
        pengGuna.setMaximumSize(new java.awt.Dimension(300, 40));
        pengGuna.setMinimumSize(new java.awt.Dimension(300, 40));
        pengGuna.setPreferredSize(new java.awt.Dimension(300, 40));
        ...
        optingLiatin.setBackground(new java.awt.Color(0, 51, 153));
        optingLiatin.setFont(new java.awt.Font("Minecraft", 1, 20)); // NOI18N
        optingLiatin.setForeground(new java.awt.Color(7, 210, 7));
        optingLiatin.setText("Overview");
        optingLiatin.setToolTipText("");
        optingLiatin.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(255, 255, 255)));
        optingLiatin.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        optingLiatin.setMaximumSize(new java.awt.Dimension(182, 41));
        optingLiatin.setMinimumSize(new java.awt.Dimension(182, 41));
        optingLiatin.setPreferredSize(new java.awt.Dimension(182, 41));
        optingLiatin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optingLiatinActionPerformed(evt);
            }
        });

        optingCustor.setBackground(new java.awt.Color(0, 51, 153));
        optingCustor.setFont(new java.awt.Font("Minecraft", 1, 20)); // NOI18N
        optingCustor.setForeground(new java.awt.Color(7, 210, 7));
        optingCustor.setText("Customer");
        optingCustor.setToolTipText("");
        optingCustor.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(255, 255, 255)));
        optingCustor.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        optingCustor.setMaximumSize(new java.awt.Dimension(182, 41));
        optingCustor.setMinimumSize(new java.awt.Dimension(182, 41));
        optingCustor.setPreferredSize(new java.awt.Dimension(182, 41));
        optingCustor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optingCustorActionPerformed(evt);
            }
        });

        optingStuffs.setBackground(new java.awt.Color(0, 51, 153));
        optingStuffs.setFont(new java.awt.Font("Minecraft", 1, 20)); // NOI18N
        optingStuffs.setForeground(new java.awt.Color(7, 210, 7));
        optingStuffs.setText("Stuff");
        optingStuffs.setToolTipText("");
        optingStuffs.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(255, 255, 255)));
        optingStuffs.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        optingStuffs.setMaximumSize(new java.awt.Dimension(182, 41));
        optingStuffs.setMinimumSize(new java.awt.Dimension(182, 41));
        optingStuffs.setPreferredSize(new java.awt.Dimension(182, 41));
        optingStuffs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optingStuffsActionPerformed(evt);
            }
        });

        optingPesanan.setBackground(new java.awt.Color(0, 51, 153));
        optingPesanan.setFont(new java.awt.Font("Minecraft", 1, 20)); // NOI18N
        optingPesanan.setForeground(new java.awt.Color(7, 210, 7));
        optingPesanan.setText("Orders");
        optingPesanan.setToolTipText("");
        optingPesanan.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(255, 255, 255)));
        optingPesanan.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        optingPesanan.setMaximumSize(new java.awt.Dimension(182, 41));
        optingPesanan.setMinimumSize(new java.awt.Dimension(182, 41));
        optingPesanan.setPreferredSize(new java.awt.Dimension(182, 41));
        optingPesanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optingPesananActionPerformed(evt);
            }
        });
        ...
        opsiKeServisLayout.setHorizontalGroup(
            ...
            .addGroup(opsiKeServisLayout.createSequentialGroup()
                ...
                .addGroup(opsiKeServisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(optingLiatin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(optingCustor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        optingLiatin.getAccessibleContext().setAccessibleDescription("Button of Overview");
        optingCustor.getAccessibleContext().setAccessibleName("Customer Option");
        optingCustor.getAccessibleContext().setAccessibleDescription("Option of Customer");
        optingStuffs.getAccessibleContext().setAccessibleName("Stuff Option");
        optingStuffs.getAccessibleContext().setAccessibleDescription("Option of Stuff");
        optingPesanan.getAccessibleContext().setAccessibleName("Orders Option");
        optingPesanan.getAccessibleContext().setAccessibleDescription("Option of Orders");
    ...
    //
    private void optingLiatinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optingLiatinActionPerformed
        AdminOverviewDisplay keOverview = new AdminOverviewDisplay();
        liatServis.removeAll();     // Clear Frame ini
        //
        liatServis.add(keOverview).setVisible(true);    // Menambahkan konten ke JPanel
    }//GEN-LAST:event_optingLiatinActionPerformed

    //

    private void optingCustorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optingCustorActionPerformed
        AdminListDisplay kePelanggan = new AdminListDisplay();
        liatServis.removeAll();     // Clear Frame ini
        //
        liatServis.add(kePelanggan).setVisible(true);   // Menambahkan konten ke JPanel
    }//GEN-LAST:event_optingCustorActionPerformed

    //

    private void optingStuffsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optingStuffsActionPerformed
        AdminStuffDisplay keBarangan = new AdminStuffDisplay();
        liatServis.removeAll();     // Clear Frame ini
        liatServis.add(keBarangan).setVisible(true);    // Menambahkan konten ke JPanel
    }//GEN-LAST:event_optingStuffsActionPerformed
    ...
    private void tomboLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tomboLogOutActionPerformed
        System.out.println("==~== ==~== ==~==");    // Batasin
        System.out.println("Logging Out Admin Dashboard...");
        System.out.println("==~== ==~== ==~==");    // Batasin
        //
        this.dispose();
        //
    ...
    private void optingPesananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optingPesananActionPerformed
        AdminOrderDisplay kePesanan = new AdminOrderDisplay();
        liatServis.removeAll();
        //
        liatServis.add(kePesanan).setVisible(true);
    }//GEN-LAST:event_optingPesananActionPerformed
    //
    private void x3() {
        //
    }

    public void AppOp_Admin() {
        /* Rumusan File */
        ...
        /* Sistem Pembukaan */
        String sistematik = "Admin Dashboard";
        //
        //System.out.println("");
        //System.out.println("==~== ==~== ==~==");  // Batasin
    ...
    public static void main(String args[]) {
        ...
        System.out.println("==~== ==~== ==~==");  // Batasin
        //
        AdminDashboardPage bukapp = new AdminDashboardPage();
        bukapp.AppOp_Admin();
        /* Memastikan File mampu menjalankan program (membuka GUI) */
    ...
    private javax.swing.JButton optingCustor;
    private javax.swing.JButton optingLiatin;
